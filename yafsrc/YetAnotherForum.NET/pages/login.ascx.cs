		...
		protected void Page_Load([NotNull] object sender, [NotNull] EventArgs e)
		{
				...
				&& (Config.FacebookAPIKey.IsSet() || Config.TwitterConsumerKey.IsSet() || Config.GoogleClientID.IsSet()))
			{
				...
				else
				{
						...
						case AuthService.twitter:
							{
								...
								// If new registrations is disabled do not prompt the user with the option
					...
					// We always select the first one no matter how many options
					singleSignOnOptions.SelectedIndex = 0;
				}
			}
